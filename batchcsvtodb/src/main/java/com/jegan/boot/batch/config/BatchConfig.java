package com.jegan.boot.batch.config;
...
import com.jegan.boot.batch.model.Product;
...
public class BatchConfig {
	...
	public DataSource dataSource() {
		...
		source.setUrl("jdbc:mysql://localhost:3306/mydb?serverTimezone=UTC");
		source.setUsername("root");
		source.setPassword("jcbmysql");
		return source;
